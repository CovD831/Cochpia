      ...
      try {
        ...
        for (const document of state.indexDocuments) {
          if (usePgvector) {
            ...
            // R-011: the embedding column is jsonb - a bare JS array is sent
            // as a Postgres array literal ({...}), which jsonb rejects and
            // aborts the whole save transaction. Serialize like the pgvector
            // branch does.

...
// Regression: this module (and the standalone service that imports it from
// services/memory-module/index.js) must keep resolving. It was deleted in
// d3a6d81 on a flawed "zero non-test references" audit that missed the
// services/ tree, which broke `node services/memory-module/index.js` at
// module-load time. Recreated against the live building blocks.
